    ...
    */
    ...
    public R save(@RequestBody FangwuEntity fangwu, HttpServletRequest request){
        ...
        Wrapper<FangwuEntity> queryWrapper = new EntityWrapper<FangwuEntity>()
            ...
            .eq("quyu_types", fangwu.getQuyuTypes())
            .eq("huxing_types", fangwu.getHuxingTypes())
...
//                            fangwuEntity.setQuyuTypes(Integer.valueOf(data.get(0)));   //区域 要改的
//                            fangwuEntity.setHuxingTypes(Integer.valueOf(data.get(0)));   //户型 要改的
//                            fangwuEntity.setFangwuPingfang(data.get(0));                    //平方 要改的
//                            fangwuEntity.setFangwuDanjia(data.get(0));                    //单价/平方 要改的
//                            fangwuEntity.setFangwuOldMoney(data.get(0));                    //房屋原总价 要改的
//                            fangwuEntity.setFangwuNewMoney(data.get(0));                    //现总价 要改的
