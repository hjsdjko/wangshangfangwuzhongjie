...
//                            fangwuOrderEntity.setFangwuOrderUuidNumber(data.get(0));                    //订单号 要改的
    ...
    */
    ...
    public R add(@RequestBody FangwuOrderEntity fangwuOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,fangwuOrder:{}",this.getClass().getName(),fangwuOrder.toString());
            ...
            }else if(fangwuEntity.getFangwuzhuangtaiTypes()==2){
                return R.error(511,"房屋已经售出了");
            }
            ...
            double balance = yonghuEntity.getNewMoney() - fangwuEntity.getFangwuNewMoney();//余额
            if(balance<0)
                return R.error(511,"余额不够支付");
            fangwuOrder.setFangwuOrderTypes(1); //设置订单状态为已支付
            fangwuOrder.setFangwuOrderTruePrice(fangwuEntity.getFangwuNewMoney()); //设置实付价格
        ...
        fangwuEntity.setFangwuzhuangtaiTypes(2);
